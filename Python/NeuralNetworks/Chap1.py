# -*- coding: utf-8 -*-
"""
Created on Sun Sep 15 16:28:10 2019
...
class Network(object):
    ...
    def __init__(self, sizes):
        ...
        the second layer 3 neurons, and the third layer 1 neuron. The biases and
        weights for the network are initialized randomly, using a Gaussian distribution
        with mean 0, and variance 1. Note that the first layer is assumed to be
        an input layer, and by convention we won't set any biases for neurons,
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        self.weights = [w-(eta/len(mini_batch))* nw
                        for w, nw in zip(self.weights, nablya_w)]
    ...
    def backprop(self, x, y):
        ...
        #feedforward
        activation = x
        activations = [x]#list to store all teh activations, layer by layer
        ...
        #l = 1 means the last layer of neurons, l = 2 is the second
        #last layer, and so on. It's a renumbering of the scheme in 
        #the book, used here to take advantage of the fact that Python
    ...
    def evaluate(self, test_data):
        ...
        the correct result. Note that the neural networks output is assumed to 
        be the index of whichever neurin in the final layer has the highest
        activation."""
